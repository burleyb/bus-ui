...
console.log("CRON_TABLE", CRON_TABLE)
var EVENT_TABLE = leo.configuration.resources.LeoEvent;
console.log("EVENT_TABLE", EVENT_TABLE)
var SYSTEM_TABLE = leo.configuration.resources.LeoSystem;
console.log("SYSTEM_TABLE", SYSTEM_TABLE)
var STATS_TABLE = config?.leosdk?.LeoStats;
...
module.exports = function(event, callback) {
	...
	if(event.params.querystring.timestamp == "undefined") {
		request_timestamp = moment();
	} else {
		request_timestamp = moment(event.params.querystring.timestamp);
	}

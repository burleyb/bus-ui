...
import { useData } from './stores/DataContext.jsx'; // Assuming DataContext is already created
...
import MessageCenter from './components/Layout/MessageCenter.jsx';
import DataSourceConnect from './components/dialogs/dataSourceConnect.jsx';

function App() {
    const state = useData(); // Use context instead of Redux and MobX

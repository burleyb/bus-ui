...
const PayloadSearch = (props) => {
    ...
    function init(props) {
        ...
        if (props.eventId) {
            ...
            timeFrame = '';
        } else if (!dataStore.timePeriod?.begin || props.forceNow) {
            ...
            timestamp = 'z' + moment.utc(dataStore.timePeriod.startTimestamp).format(timeFormat) + moment(dataStore.timePeriod.startTimestamp).valueOf();
            timeFrame = '';
        }
